...
public class ThreeWheelTuner extends Procedure {
    ...
    private static String leftEncoderName = "front_left";
    private static String rightEncoderName = "rear_right";
    private static String strafeEncoderName = "front_right";
    ...
    public void run() throws InterruptedException {
        ...
        Inputs.Field<String> leftEncoder = setup.s("Left Encoder Motor Name").withDefault("front_left");
        Inputs.Field<String> rightEncoder = setup.s("Right Encoder Motor Name").withDefault("rear_right");
        Inputs.Field<String> strafeEncoder = setup.s("Strafe Encoder Motor Name").withDefault("front_right");
        awaitInputs(setup);
    ...
    static ThreeWheelLocalizer localizer(HardwareMap map, ThreeWheelConfig config) {
        ...
        for (String name : new String[]{"front_left", "rear_left", "front_right", "rear_right"}) {
            DcMotorEx motor = map.get(DcMotorEx.class, name);
            motor.setPower(0);
            motor.setDirection(name.equals("front_right") || name.equals("rear_right")
